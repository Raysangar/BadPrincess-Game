	...
	*/
	...
	public:
		...
		*/
		...
		/*
		Function that cycle all Ogre ResourceGroupManager and reload all Ogre Resourcemanagers
		*/
		void reloadOgreResource();

		void changeResolution(Options::Resolution resolution, bool fullScreen);

		void changeAntialiasing(int antialiasingLevel);

		void setFullScreen(bool active, Options::Resolution resolution);

		void setVSync(bool active);

		Options* getGameOptions() { return gameOptions; }
	...
	protected:
		...
		*/
		void close();
		/**
		Inicialización de Servidor de lua.
		...
		*/
		...
		void setOgreConfigOption(std::string attributeName, std::string attributeValue);
