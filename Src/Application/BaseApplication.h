	...
	*/
	...
	public:
		...
		*/
		...
		Libera y elimina todos los estados de la aplicación.
		*/
		bool releaseState(const std::string &name);
		...
		*/
		...
		bool stackState(const std::string &stateName);
		...
		*/
		CApplicationState *getState() {return currentStates.top();}
		...
		*/
		...
		CApplicationState *findState(std::string stateName);
	...
	protected:
		...
		*/
		...
		CApplicationState* nextStackedState;

		bool unstackStatePending;
		...
		*/
		...
		std::stack<CApplicationState*> currentStates;
