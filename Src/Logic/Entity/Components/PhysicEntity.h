...
{	
	...
	*/
	...
	public:
		...
		*/
		CPhysicEntity(std::string componentName);
		...
		*/
		...
		const physx::PxRigidActor * getActor(){return _actor;};

		const Vector3 getActorDimensions();
	...
	private:
		...
		*/
		...
		Physics::ActorFactory* actorFactory;
