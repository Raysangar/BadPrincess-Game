...
*/
	...
	public:
		...
		*/
		IComponent() : _entity(0), componentType("") {}
		IComponent(std::string componentType) : _entity(0), componentType(componentType) {}
		...
		*/
		...
		Method that returns the component type in string format.
	...
	protected:
		...
		*/
		...
		/**
		Component type, used for searching single components from an entity
		*/
...
{ \
	IComponent* res = new Class(#Class); \
	return res; \
} \
bool Class::regist() \
{ \
