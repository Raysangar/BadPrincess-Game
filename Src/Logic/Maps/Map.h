	...
	*/
	...
	public:
		...
		*/
		...
		/**
		Function which reactivates all paused entities.

		@return Retursn true if succesful.
		*/
		bool restart();
		...
		Method that calls to awake method of all entities
		*/
		void awake();
		...
		*/
		...
		/*
			Loop throw all the entities contained into Map and send it a Message

			@param message The reference of a message that will be sent to the entities
		*/
		void sendMessageToAll(const std::shared_ptr<NMessage> &message);
