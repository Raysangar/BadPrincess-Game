...
namespace GUI
{
	...
	*/
	...
	public:
		...
		métodos devuelven false.
		*/
		virtual bool mouseMoved(const CMouseState &mouseState,const bool alreadyManaged)
														{return false;}
		...
		métodos devuelven false.
		*/
		virtual bool mousePressed(const CMouseState &mouseState,const bool alreadyManaged)
														{return false;}
		...
		métodos devuelven false.
		*/
		virtual bool mouseReleased(const CMouseState &mouseState,const bool alreadyManaged)
														{return false;}
	...
	*/
	...
	public:
		...
		*/
		...
		Method to retrive mouse state
		*/
		CMouseState& getLogicMouseState();
