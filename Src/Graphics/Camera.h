	...
	*/
	...
	public:
		...
		*/
		...
		Ogre::Frustum* getFrustum(){return _camera->getCullingFrustum();};
		...
		*/
		...
		void setCompositor(std::string compositorName);

		void enableCompositor(std::string compositorName);

		void disableCompositor(std::string compositorName);
