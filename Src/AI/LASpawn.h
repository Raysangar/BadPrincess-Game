...
#ifndef __AI_LASpawn_H
#define __AI_LASpawn_H
...
namespace AI 
{
	...
	*/
	class CLASpawn : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLASpawn(Logic::CEntity *entity) : CLatentAction() 
		{
			_entity = entity;
		};
		/**
	...
	private:
		...
		Logic::CAnimatedGraphics* _animatedGraphicsComponent;
	};
