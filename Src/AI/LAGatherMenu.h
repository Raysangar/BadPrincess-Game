...
#ifndef __AI_LAGatherMenu_H
#define __AI_LAGatherMenu_H
...
namespace AI 
{
	...
	*/
	class CLAGatherMenu : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAGatherMenu(Logic::CEntity *entity) : CLatentAction()
		{
			_entity = entity;
		};
		/**
