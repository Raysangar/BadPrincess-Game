...
#ifndef __AI_LATaken_H
#define __AI_LATaken_H
...
namespace AI 
{
	...
	*/
	class CLATaken : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLATaken(Logic::CEntity *entity) : CLatentAction() { setEntity(entity); };
		/**
		Destructor
		*/
		~CLATaken() {};
	...
	private:
		...
		Logic::CPrincessManager* _princessManagerComponent;
		Logic::CSteeringMovement* _raptorSteeringComponent;
