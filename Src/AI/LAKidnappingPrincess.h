/**
@file LAKidnappingPrincess.h

Representa el estado de transicion entre el coger a la princesa y huir
...
#ifndef __AI_LAKidnappingPrincess_H
#define __AI_LAKidnappingPrincess_H
...
namespace AI
{
	...
	*/
	class CLAKidnappingPrincess : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAKidnappingPrincess(Logic::CEntity *entity) : CLatentAction()
		{
			_entity = entity;
		};
		/**
...
#endif // __AI_LAKidnappingPrincess_H