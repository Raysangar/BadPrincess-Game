...
#ifndef __AI_LAStunned_H
#define __AI_LAStunned_H
...
namespace AI 
{
	...
	*/
	class CLAStunned : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAStunned(Logic::CEntity *entity): _direction(Vector3::ZERO), _origin(Vector3::ZERO), _distance(0), _waitTime(0), _currentWaitTime(0), _stunned(false)
		{
			_entity = entity;
		};
		/**
		...
		*/
		...
		<p>
		Al comenzar establecemos la animación Idle
