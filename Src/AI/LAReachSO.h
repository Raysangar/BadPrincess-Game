...
#ifndef __AI_LAReachSO_H
#define __AI_LAReachSO_H
...
namespace AI 
{
	...
	*/
	class CLAReachSO : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAReachSO(Logic::CEntity *entity) : CLatentAction(),_interactComponent(nullptr) 
		{
			_entity = entity;
		};
		/**
