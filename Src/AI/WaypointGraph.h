...
public:
	...
	*/
	std::list<unsigned int> getNeighbours(int idNode) { return _g.getNeighbours(idNode); };
	/**
...
private:
	...
	*/
	...
	////DEBUG show graph
	//std::list<Graphics::CMeshEntity*> _wpgGraphicsList;
	//std::list<Graphics::CManualEntity*> _wpgGraphicsEdgeList;
