...
#ifndef __AI_LAWaiting_H
#define __AI_LAWaiting_H
...
namespace AI 
{
	...
	*/
	class CLAWaiting : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAWaiting(Logic::CEntity *entity,unsigned int time) : CLatentAction(),_currentWaitTime(0),_waitTime(time)
		{
			_entity = entity;
		};
		/**
