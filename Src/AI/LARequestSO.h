...
#ifndef __AI_LARequestSO_H
#define __AI_LARequestSO_H
...
namespace AI 
{
	...
	*/
	class CLARequestSO : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLARequestSO(Logic::CEntity *entity) : CLatentAction(), _interactComponent(nullptr),_lastRouteToAttempt(0),_numberOfAttempt(0)
		{
			_entity = entity;
		};
		/**
	...
	private:
		...
		unsigned int _lastRouteToAttempt;
		int _numberOfAttempt;
		LAStatus tryToAttemptRouteTo(Vector3 position);
	};
