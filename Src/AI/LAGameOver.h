...
Representa el estado de conseguir escapar con la autentica princesa
...
#ifndef __AI_LAGameOver_H
#define __AI_LAGameOver_H
...
namespace AI
{
	...
	*/
	class CLAGameOver : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAGameOver(Logic::CEntity *entity) : CLatentAction()
		{
			_entity = entity;
		};
		/**
