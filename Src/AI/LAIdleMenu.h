...
#ifndef __AI_LAIdleMenu_H
#define __AI_LAIdleMenu_H
...
namespace AI 
{
	...
	*/
	class CLAIdleMenu : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAIdleMenu(Logic::CEntity *entity) : CLatentAction()
		{
			_entity = entity;
		};
		/**
