...
#ifndef __AI_LAChaseCarriedEntity_H
#define __AI_LAChaseCarriedEntity_H
...
namespace Logic{
	...
	class CChaseCarriedEntityState;
};
...
namespace AI 
{
	...
	*/
	class CLAChaseCarriedEntity : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAChaseCarriedEntity(Logic::CEntity *entity) : CLatentAction(),_carrierSteering(nullptr),_chaseState(nullptr),_slowSpeed(false),_carrierEntity(nullptr)
		{
			_entity = entity;
		};
		/**
	...
	private:
		...
		void sendRouteMessage(Vector3 target);

		bool checkClosestEntity();

		bool _slowSpeed;

		Logic::CChaseCarriedEntityState *_chaseState;
		Logic::CEntity *_carrierEntity;
		Logic::CSteeringMovement* _carrierSteering;
	
	};

} //namespace AI 

#endif // __AI_LAChaseCarriedEntity_H