/**
@file CLAWaitCarriedEntity.h

Represents the state of waiting for carried entity
...
#ifndef __AI_LAWaitCarriedEntity_H
#define __AI_LAWaitCarriedEntity_H
...
namespace AI 
{
	...
	*/
	class CLAWaitCarriedEntity : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAWaitCarriedEntity(Logic::CEntity *entity) : CLatentAction(),_transportedComponent(nullptr),_carrierSteeringComponent(nullptr)
		{
			_entity = entity;
		};
		/**
	...
	private:
		...
		Logic::CTransportedComponent* _transportedComponent;
		Logic::CSteeringMovement* _carrierSteeringComponent;
	
	};

} //namespace AI 

#endif // __AI_LAWaitCarriedEntity_H