...
#ifndef __AI_LABuild_H
#define __AI_LABuild_H
...
namespace AI 
{
	...
	*/
	class CLABuild : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLABuild(Logic::CEntity *entity,bool princessNeeded) : CLatentAction(),_state(0),_princessNeeded(princessNeeded),_buildState(nullptr),_currentTimeBuild(0),_princess(nullptr),_princessState(nullptr),_buildLife(nullptr) { setEntity(entity); };
		/**
		Destructor
		*/
		~CLABuild() {};
	...
	private:
		...
		*/
		unsigned long _currentTimeBuild;

		bool _princessNeeded;

		Logic::CWorkmanState* _state;
		Logic::CBuildComponent* _buildState;
		Logic::CEntity* _princess;
		Logic::CPrincessManager* _princessState;
		Logic::CLife* _buildLife;
	};
