...
#ifndef __AI_LAWaitBuild_H
#define __AI_LAWaitBuild_H
...
namespace AI 
{
	...
	*/
	class CLAWaitBuild : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLAWaitBuild(Logic::CEntity *entity,bool princessNeeded) : CLatentAction(),_state(nullptr),_princessNeeded(princessNeeded),_princess(nullptr) { setEntity(entity); };
		/**
		Destructor
		*/
		~CLAWaitBuild() {};
